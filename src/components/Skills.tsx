...
const skillCategories = [
  {
    ...
    icon: Code2,
    skills: [
      { name: "React", level: "Avanzado", progress: 80 },
      { name: "JavaScript", level: "Avanzado", progress: 80 },
      { name: "TypeScript", level: "Avanzado", progress: 80 },
      { name: "Tailwind CSS", level: "Avanzado", progress: 80 },
    ],
  },
  {
    title: "Backend",
    icon: Server,
    skills: [
      { name: "Node.js", level: "Intermedio-Avanzado", progress: 70 },
      { name: "Express", level: "Intermedio-Avanzado", progress: 70 },
      { name: "Python", level: "Avanzado", progress: 80 },
      { name: "C", level: "Avanzado", progress: 85 },
    ],
  },
  {
    ...
    icon: Database,
    skills: [
      { name: "MySQL", level: "Intermedio-Avanzado", progress: 75 },
      { name: "SQL Server", level: "Intermedio", progress: 65 },
    ],
  },
  {
    title: "Herramientas",
    icon: Wrench,
    skills: [
      { name: "Power BI", level: "Intermedio", progress: 60 },
      { name: "GitHub", level: "Intermedio-Avanzado", progress: 75 },
      { name: "VS Code", level: "Intermedio-Avanzado", progress: 75 },
      { name: "Jira", level: "Intermedio-Avanzado", progress: 70 },
    ],
  },
  {
    title: "DevOps & Cloud",
    icon: Cloud,
    skills: [
      { name: "Docker", level: "Basico-Intermedio", progress: 40 },
      { name: "Oracle Cloud", level: "Basico-Intermedio", progress: 40 },
      { name: "Linux", level: "Intermedio", progress: 65 },
      { name: "Git", level: "Avanzado", progress: 65 },
    ],
  },
  {
    ...
    icon: Workflow,
    skills: [
      { name: "BPMN", level: "Intermedio-Avanzado", progress: 70 },
      { name: "SIMPLE", level: "Intermedio-Avanzado", progress: 70 },
      { name: "Análisis de procesos", level: "Avanzado", progress: 80 },
    ],
  },
];
